...
\begin{document}
    ...
    \begin{figure}[htbp]
        \begin{tikzpicture}[node distance=2cm]
            ...
            \node (c) [rectangle, draw, text width=5cm, minimum height=1cm, text centered, below of=b] {\textbf{Grid Search} \\ to find optimal hyperparameters for following algorithms};
            \node (e) [rectangle, draw, text width=5cm, minimum height=1cm, text centered, below of=c] {\textbf{Dimensionality Reduction} \\ PCA to explain upto 98\% of the variance};
            \node (f) [rectangle, draw, text width=5cm, minimum height=1cm, text centered, below of=e] {\textbf{Dimensionality Reduction} \\ LDA to capture the separation of data into 19 clusters};
